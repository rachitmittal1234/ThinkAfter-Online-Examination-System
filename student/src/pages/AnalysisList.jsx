...
const AnalysisList = () => {
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="max-w-md mx-auto px-4 py-20">
            <div className="bg-white rounded-xl shadow-lg p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">Please login to access your analysis</p>
              <button
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex justify-center items-center bg-gray-50">
        <p className="text-lg text-gray-500">Loading analysis...</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen p-6 bg-gray-50">
      <div className="max-w-5xl mx-auto">
        <Navbar />
        <h2 className="text-2xl font-semibold text-blue-700 my-6">🧠 Post Test Analysis</h2>

        {reports.length === 0 ? (
          <p className="text-gray-500">No attempted tests available for analysis</p>
        ) : (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <button
                        ...
                        onClick={() => navigate(`/analysis/${report._id}/do`)}
                      >
                        Do Analysis
                      </button>
                    </td>
